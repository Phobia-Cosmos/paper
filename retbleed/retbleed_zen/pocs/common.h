...
static u64 get_next(u64 cur, int nbits)
{
    ...
    // TODO:__builtin_popcountll是什么作用?
...
// TODO:__VA_ARGS__是什么功能?为什么可以传入这个参数?do while0是什么?
#define map_or_die(...)                      \
    do                                       \
    {                                        \
